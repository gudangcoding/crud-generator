                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                style="background-image: url({{ asset('assets/tabler/static/avatars/000m.jpg') }})"></span>
                            <div class="d-none d-xl-block ps-2">
                                <div>Ahmad Naufal Khalid</div>
                                <div class="mt-1 small text-muted">Fullstack Developer</div>
                            </div>
                        </a>

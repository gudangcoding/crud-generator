@extends('layouts.app')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <a href="{{ route('crudtransaksi.create') }}" class="btn btn-success">Tambah Data</a>
                    <button type="button" class="btn btn-primary" id="bulkDelete">Hapus Data Terpilih</button>
                </div>
                <div class="mb-3">
                <form action="{{ route('crudtransaksi.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
            ...
            $(document).ready(function() {
                ...
                function bulkDelete() {
                    ...
                    if (selectedIds.length > 0) {
                        ...
                        $.ajax({
                            url: '{{ route('crudtransaksi.bulkDelete') }}',
                            type: 'POST',
                            data: {
                                ids: selectedIds,
                                _token: '{{ csrf_token() }}'
